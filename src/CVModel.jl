...
#   Pulm_art.C.out.cO₂ => 0.0,
  Pulm_vein.C.out.cO₂ => 0.200,
  LA.out.cO₂ => 0.200,
  LV.out.cO₂ => 0.200,
  Cor_art.C.out.cO₂ => 0.200,
  Asc_A.C.out.cO₂ => 0.200,
  BC_A.C.out.cO₂ => 0.200,
  UpBd_art.C.out.cO₂ => 0.200,
  Thor_A.C.out.cO₂ => 0.200,
  Abd_A.C.out.cO₂ => 0.200,
  Renal_art.C.out.cO₂ => 0.200,
  Splanchnic_art.C.out.cO₂ => 0.200,
  Leg_art.C.out.cO₂ => 0.200,
  CommonCarotid.C.out.cO₂ => 0.200,
  Head_art.C.out.cO₂ => 0.200,
  #### Blood Gas O₂ Venous
  Cor_vein.C.out.cO₂ => 0.191,
  UpBd_vein.C.out.cO₂ => 0.191,
  SVC.C.out.cO₂ => 0.191,
  Renal_vein.C.out.cO₂ => 0.191,
  Splanchnic_vein.C.out.cO₂ => 0.191,
  Leg_vein.C.out.cO₂ => 0.191,
  Abd_veins.C.out.cO₂ => 0.191,
  Thor_IVC.C.out.cO₂ => 0.191,
  Head_veins.C.out.cO₂ => 0.191,
  Jugular_vein.C.out.cO₂ => 0.191,
  RA.out.cO₂ => 0.191,
  RV.out.cO₂ => 0.191,

  #### Blood Gas CO₂ Arterial
#   Pulm_art.C.out.cCO₂ => 0.0,
  Pulm_vein.C.out.cCO₂ => 0.458,
  LA.out.cCO₂ => 0.458,
  LV.out.cCO₂ => 0.458,
  Cor_art.C.out.cCO₂ => 0.458,
  Asc_A.C.out.cCO₂ => 0.458,
  BC_A.C.out.cCO₂ => 0.458,
  UpBd_art.C.out.cCO₂ => 0.458,
  Thor_A.C.out.cCO₂ => 0.458,
  Abd_A.C.out.cCO₂ => 0.458,
  Renal_art.C.out.cCO₂ => 0.458,
  Splanchnic_art.C.out.cCO₂ => 0.458,
  Leg_art.C.out.cCO₂ => 0.458,
  #### Blood Gas CO₂ Venous
  Cor_vein.C.out.cCO₂ => 0.514,
  UpBd_vein.C.out.cCO₂ => 0.514,
  SVC.C.out.cCO₂ => 0.514,
  Renal_vein.C.out.cCO₂ => 0.514,
  Splanchnic_vein.C.out.cCO₂ => 0.514,
  Leg_vein.C.out.cCO₂ => 0.514,
  Abd_veins.C.out.cCO₂ => 0.514,
  Thor_IVC.C.out.cCO₂ => 0.514,
  CommonCarotid.C.out.cCO₂ => 0.514,
  Head_art.C.out.cCO₂ => 0.514,
  Head_veins.C.out.cCO₂ => 0.514,
  Jugular_vein.C.out.cCO₂ => 0.514,
  RA.out.cCO₂ => 0.514,
  RV.out.cCO₂ => 0.514,
