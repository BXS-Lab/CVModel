...
#   Pulm_art.C.out.cO₂ => 0.0,
  Pulm_vein.C.out.cO₂ => 0.204,
  LA.out.cO₂ => 0.204,
  LV.out.cO₂ => 0.204,
  Cor_art.C.out.cO₂ => 0.204,
  Cor_vein.C.out.cO₂ => 0.154,
  Asc_A.C.out.cO₂ => 0.204,
  BC_A.C.out.cO₂ => 0.204,
  UpBd_art.C.out.cO₂ => 0.204,
  Thor_A.C.out.cO₂ => 0.204,
  Abd_A.C.out.cO₂ => 0.204,
  Renal_art.C.out.cO₂ => 0.204,
  Splanchnic_art.C.out.cO₂ => 0.204,
  Leg_art.C.out.cO₂ => 0.204,
  UpBd_vein.C.out.cO₂ => 0.154,
  SVC.C.out.cO₂ => 0.154,
  Renal_vein.C.out.cO₂ => 0.154,
  Splanchnic_vein.C.out.cO₂ => 0.154,
  Leg_vein.C.out.cO₂ => 0.154,
  Abd_veins.C.out.cO₂ => 0.154,
  Thor_IVC.C.out.cO₂ => 0.154,
  CommonCarotid.C.out.cO₂ => 0.204,
  Head_art.C.out.cO₂ => 0.204,
  Head_veins.C.out.cO₂ => 0.154,
  Jugular_vein.C.out.cO₂ => 0.154,

  #### Blood Gas CO₂
  RA.out.cCO₂ => 0.533,
  RV.out.cCO₂ => 0.533,
#   Pulm_art.C.out.cCO₂ => 0.0,
  Pulm_vein.C.out.cCO₂ => 0.042,
  LA.out.cCO₂ => 0.042,
  LV.out.cCO₂ => 0.042,
  Cor_art.C.out.cCO₂ => 0.042,
  Cor_vein.C.out.cCO₂ => 0.0,
  Asc_A.C.out.cCO₂ => 0.042,
  BC_A.C.out.cCO₂ => 0.042,
  UpBd_art.C.out.cCO₂ => 0.042,
  Thor_A.C.out.cCO₂ => 0.042,
  Abd_A.C.out.cCO₂ => 0.042,
  Renal_art.C.out.cCO₂ => 0.042,
  Splanchnic_art.C.out.cCO₂ => 0.042,
  Leg_art.C.out.cCO₂ => 0.042,
  UpBd_vein.C.out.cCO₂ => 0.533,
  SVC.C.out.cCO₂ => 0.533,
  Renal_vein.C.out.cCO₂ => 0.533,
  Splanchnic_vein.C.out.cCO₂ => 0.533,
  Leg_vein.C.out.cCO₂ => 0.533,
  Abd_veins.C.out.cCO₂ => 0.533,
  Thor_IVC.C.out.cCO₂ => 0.533,
  CommonCarotid.C.out.cCO₂ => 0.533,
  Head_art.C.out.cCO₂ => 0.533,
  Head_veins.C.out.cCO₂ => 0.533,
  Jugular_vein.C.out.cCO₂ => 0.533,
